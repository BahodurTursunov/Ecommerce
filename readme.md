...
## Если вы пользователь Linux, То рекомендую сразу перейти по этой ссылке и скачать нужные файлы для дальнейшей работы с проектом <a href ="#" src = https://metanit.com/sharp/aspnet6/1.3.php"/>
